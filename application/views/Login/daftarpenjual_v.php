...
<main class="form-signin w-100 m-auto">
  <form method='post'>
    ...
    <div class="form-floating">
      ...
      <label for="floatingInput">Id Penjual</label>
    <div class="form-floating">
      <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com">
    ...
    <div class="form-floating">
      ...
      <label for="floatingPassword">Nama Pemilik</label>
    </div>
    <div class="form-floating">
    ...
    <a class="btn btn-primary btn-lg" href="<?= base_url('login/penjual') ?>">Daftar</a>
