...
<main class="form-signin w-100 m-auto">
  <form method='post' action="<?= base_url('Daftar') ?>">
    ...
    <h1 class="h3 mb-3 fw-normal">Daftar Akun Pengguna</h1>
    ...
    <div class="form-floating">
      ...
      <input name="password" type="password" class="form-control" id="floatingInput" placeholder="name@example.com" required>
      <label for="floatingInput">Password</label>
    
    <!-- <div class="form-floating">
      <input name="id_user" type="email" class="form-control" id="floatingInput" placeholder="name@example.com">
      <label for="floatingInput">Username (  )</label>
    </div> -->
    <br>
    <input type="submit" class="w-100 btn btn-lg btn-primary mb-1">Daftar</a>
