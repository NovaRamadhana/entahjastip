        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Content Row -->
                    <div class="row">
                    <?php if(isset($logged_in['admin']) || $logged_in['penjual']){ ?>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= formatangka($total_pengeluaran); ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-money-bill fa-2x text-gray-300"></i>
                                        </div>
                            ...
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Ajuan Penjual Pending</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $pending_penjual ?></div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Daftar Gerai / Penjual</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $penjual_diterima ?></div>
                                        </div>
                                        <div class="col-auto">
